  ...
  <div class="landing">
    ...
    <header class="lp-header" @keydown.esc="mobileMenuOpen = false">
      <div class="lp-container lp-nav">
        <NuxtLink to="/" aria-label="Página inicial" class="lp-logo"
          ><AppLogo
        /></NuxtLink>
        ...
        <div class="lp-nav-actions">
          <NuxtLink
            ...
            >Entrar <UIcon name="i-lucide-arrow-up-right"
          /></NuxtLink>
          <NuxtLink
            to="/signup"
            class="lp-button lp-button-dark lp-nav-cta"
            @click="track('Começar agora', '/signup', 'header')"
            >Começar agora <UIcon name="i-lucide-arrow-right"
          /></NuxtLink>
          <button
        ...
        <div class="lp-container lp-hero-grid">
          <div class="lp-hero-copy">
            <span class="lp-eyebrow"
              ><span class="lp-status-dot" /> O PRÓXIMO PASSO DA SUA
              OFICINA</span
            >
            ...
            <div class="lp-hero-actions">
              <NuxtLink
                ...
                >Começar agora <UIcon name="i-lucide-arrow-up-right"
              /></NuxtLink>
              <a
                href="#sistema"
                class="lp-text-link"
            ...
            <div class="lp-hero-notes">
              <span><UIcon name="i-lucide-check" /> 100% online</span
              ><span><UIcon name="i-lucide-check" /> Feito para oficinas</span>
            </div>
          </div>
          <div class="lp-hero-visual">
            <div class="lp-orbit lp-orbit-one" aria-hidden="true" />
            <div class="lp-orbit lp-orbit-two" aria-hidden="true" />
            <span class="lp-visual-caption"
              ><UIcon name="i-lucide-zap" /> SUA OPERAÇÃO, CONECTADA.</span
            >
            <LandingProductPreview />
            <div class="lp-floating-note">
              <span class="lp-note-icon"><UIcon name="i-lucide-check" /></span>
              <div>
                <strong>Tudo pronto para a próxima entrega.</strong
                ><span>Do serviço ao pagamento, tudo conectado.</span>
              </div>
            </div>
            <span class="lp-demo-caption"
              >Prévia ilustrativa com dados de exemplo</span
            >
          </div>
        </div>
        ...
        <div class="lp-operation-grid">
          <div class="lp-workshop-image">
            ...
            <div class="lp-photo-caption">
              ...
              ><strong>Da bancada<br />à gestão.</strong
              ><span class="lp-photo-arrow" aria-hidden="true"
                ><UIcon name="i-lucide-arrow-up-right"
              /></span>
            </div>
          </div>
          <div class="lp-operation-copy">
            ...
            <NuxtLink
              ...
              >Organizar minha oficina <UIcon name="i-lucide-arrow-up-right"
            /></NuxtLink>
          </div>
        </div>
      </section>
          ...
          <div class="lp-feature-grid">
            ...
            >
              <div class="lp-feature-top">
                <span class="lp-icon-box"><UIcon :name="feature.icon" /></span
                ><span class="lp-feature-number">0{{ index + 1 }}</span>
              </div>
        ...
        <div class="lp-container lp-section">
          <div class="lp-section-heading">
            ...
            <NuxtLink
              ...
              >Vamos começar <UIcon name="i-lucide-arrow-up-right"
            /></NuxtLink>
          </div>
          <div class="lp-steps">
            <article v-for="(step, index) in steps" :key="step.title">
              <span class="lp-step-number"
                >0{{ index + 1
                }}<UIcon
                  :name="
      ...
      <section class="lp-container lp-section lp-faq-section">
        <div>
          ...
          <NuxtLink
            ...
            >Conhecer os planos <UIcon name="i-lucide-arrow-up-right"
          /></NuxtLink>
        </div>
        ...
        <div class="lp-final-cta">
          ...
          <div class="lp-final-actions">
            ...
            ><NuxtLink
              ...
              >Ver planos e preços <UIcon name="i-lucide-arrow-right"
            /></NuxtLink>
          </div>
        </div>
      </section>
    ...
    <footer class="lp-footer lp-container">
      <div class="lp-footer-top">
        ...
        <nav aria-label="Navegação do rodapé">
          <NuxtLink
            ...
            >{{ item.label }}</NuxtLink
          ><NuxtLink to="/login" @click="track('Entrar', '/login', 'footer')"
            >Entrar <UIcon name="i-lucide-arrow-up-right"
          /></NuxtLink>
        </nav>
      </div>
      <div class="lp-footer-bottom">
        <span
          >© {{ new Date().getFullYear() }} AutoPro. Todos os direitos
          reservados.</span
        ><span>Feito para quem faz a oficina acontecer.</span>
      </div>
    </footer>
  </div>
</template>
