...
const { dateFrom, dateTo, orderStatusFilters: statusFilters, paymentStatusFilters, paymentMethodFilters, clientIds, selectedEmployees: responsibleIds } = useReportDateRange()
