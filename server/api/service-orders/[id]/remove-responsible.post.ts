...
import { removeServiceOrderResponsible } from '../../../utils/service-order-responsible-admin'
 ...
 *
 * Removes one employee from responsible_employees and zeroes/consolidates
 * their commission record(s) for this order (blocks if any are already
 * paid).
 */
